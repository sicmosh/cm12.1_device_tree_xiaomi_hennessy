...
git apply -v ../../device/xiaomi/hennessy/patches/framework_base/0003-add-statusbar-headset-icons.patch
patch -p0 < ../../device/xiaomi/hennessy/patches/framework_base/0003-enable-statusbar-headset-icons-when-headset-plug-in.patch
...
git apply -v ../../device/xiaomi/hennessy/patches/framework_base/0005-enable-virtual-keys.patch
cd ../..
